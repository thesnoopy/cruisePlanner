...
class ExcursionDocumentsSection extends StatefulWidget {
  ...
  State<ExcursionDocumentsSection> createState() =>
      _ExcursionDocumentsSectionState();
}
...
class _ExcursionDocumentsSectionState extends State<ExcursionDocumentsSection> {
  ...
  Future<void> _reload() async {
    ...
    final data = await _service.loadForExcursion(widget.excursionId);
    if (!mounted) {
      return;
    }
    setState(() {
      ...
      MaterialPageRoute(
        builder: (_) => UrlSnapshotCaptureScreen(
          target: UrlDocumentTarget(
            type: UrlDocumentTargetType.excursion,
          ...
          children: [
            ...
            if (_isLoading)
              ...
              Padding(
                ...
                child: Text(
                  widget.isReadOnly
                      ? loc.noLinkedDocuments
                      : loc.noLinkedDocumentsForExcursion,
                ),
              )
            else
              Column(
