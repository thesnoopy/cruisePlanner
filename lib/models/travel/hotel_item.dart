...
class HotelItem extends TravelItem {
  ...
  @override
  List<Object?> get props => [id, kind, start, end, from, to, notes, price, currency, company, name, location, address, recordLocator, documentIds, updatedAtUtc, deletedAtUtc];
}
