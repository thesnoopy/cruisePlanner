...
class CruiseCheckOut extends TravelItem {
  @override
  final String id;
  @override
  ...
  @override
  TravelKind get kind => TravelKind.cruiseCheckOut;

  CruiseCheckOut copyWith({
    String? id,
    DateTime? start,
    DateTime? end,
    String? from,
  ...
  factory CruiseCheckOut.fromMap(Map<String, dynamic> map) => CruiseCheckOut(
        id: map['id'],
